...
| Supabase schema and RLS              | Fresh reset applied all four migrations; SQL lint passed; the expanded adversarial pgTAP suite passed 266/266 locally                                                                                                                         | Hosted policy/configuration inspection and authenticated hostile-client acceptance                                                          |
