...
| Administration/profile/notifications | Admin/profile actions, safe notifications, metadata webhook, Google-verified minimal Resend access requests, and manual prefilled approval email links implemented | Admin actor matrix, email settings/delivery/failure/duplicate hosted tests, and approval-link review |
